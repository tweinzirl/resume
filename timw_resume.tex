...
\begin{resume_section}{Work Experience}
  ...
  {San Francisco, California}{June 2017 -- Present}
    ...
    \item \texttt{AI}: Prototyped an LLM-agent for the sales team and analysts; pitched to executives and business lines. Developed machine learning models (e.g., grading loan applications, client segmentation, fuzzy matching) according to model governance standards and deployed them as self-service web (e.g., Dash) applications.
