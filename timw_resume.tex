...
\begin{resume_section}{Work Experience}
  ...
  {San Francisco, California}{June 2017 -- Present}
    ...
    \item \texttt{AI}: Prototyped a \underline{\textbf{LangChain agent}} for exploring bank data; pitched result to executives of various business lines. Developed \underline{\textbf{machine learning models}} (e.g., grading loan applications, client segmentation, fuzzy matching) according to model governance standards and deployed them as self-service web (e.g., Dash) apps.
