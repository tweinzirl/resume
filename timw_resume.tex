...
\contact{Email: \href{mailto: tweinzirl@gmail.com}{tweinzirl@gmail.com} \hspace{0.1cm} Linkedin: \url{http://www.linkedin.com/pub/tim-weinzirl/64/428/a1b} \hspace{0.1cm} Status: U.S. citizen}
\end{resume_header}

\begin{resume_section}{Skills}
  \begin{nospacetabbing}
  \textbf{Programming languages}  \= Python (2006--Present), Scala (2023--Present), SQL (2017-Present), R (2015--2017), C (2003--2007) \\* %, Java (2003--2006)
  \textbf{Technical skills} \> Snowflake, Databricks, data pipelines, machine/deep learning, Git, Docker, Linux, web scraping \\*
  \end{nospacetabbing}
...
%\begin{comment}
%  -- Technical Leadership: Prepared and promoted lectures and resources to promote foster expertise in Python, devops, and data science across the enterprise.  New: Routinely carried out R&D to solve challenges around the adoption of new packages or technology platforms (e.g., to increase write speeds to databases when moving from on-prem servers to cloud-hosted servers).
%\end{comment}
    ...
    %\item \texttt{Machine learning}: Developed self-service web apps (e.g., grading loan applications, name matching).
...
%accessing and processing data from the bank's data marts. 
  \end{resume_employer}
